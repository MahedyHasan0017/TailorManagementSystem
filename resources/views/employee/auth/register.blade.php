    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark height__full_screen">
        <div class="auth-box bg-dark border-top border-secondary ">
            <div class="">
                ...
                @if (Auth::guard('vendor')->user()->is_payment_requested == 1)
                    <div>
                        <div class="row text-white text-center">
                            <h4>Your Submission Request Has Been Added</h4>
                            <p>Please wait for our confirmation</p>
                        </div>
                    </div>
                @else
                    <div>
                        @if ($total >= Auth::guard('vendor')->user()->tailor_adding_limit)
                            @include('employee.auth.employee_package')
                        @else
                            <form class="form-horizontal mt-3" action="{{ route('auth.employee.register.store') }}"
                                method="POST">
                                @csrf
                                <div class="row pb-4">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="form-group" style="width:100% ; display : flex">
                                                    ...
                                                    <select name="designation" id=""
                                                        ...
                                                        <option value="tailor"
                                                            class="form-control employee_designation_option">
                                                            Tailor
                                                        </option>
