        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
                ...
                @if (Auth::guard('employee')->user())
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'ড্যাশবোর্ড') {
                                $x = true;
                            }
                        }
                    @endphp
                    ...
                    @if ($x == true)
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('employee_dashboard') }}" aria-expanded="false"><i
                                    class="mdi mdi-view-dashboard"></i><span class="hide-menu">ড্যাশবোর্ড</span></a>
                        </li>
                    @else
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('employee_dashboard') }}" aria-expanded="false"><i
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'পোষাক অর্ডার') {
                                $x = true;
                            }
                        }
                    @endphp
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a
                                        href="{{ route('employee.order.accepting.view', ['vendor_id' => $employee->vendor_mobile, 'employee_id' => $employee->mobile_number]) }}"
                                        class="sidebar-link"><i class="fas fa-angle-right"></i><span
                                            class="hide-menu">অর্ডার গ্রহন
                                        </span></a></li>
                                <li class="sidebar-item"><a
                                        href="{{ route('employee.order.accepting.list', ['vendor_id' => $employee->vendor_mobile, 'employee_id' => $employee->mobile_number]) }}"
                                        class="sidebar-link"><i class="fas fa-angle-right"></i><span
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'কর্মচারী পরিচালনা') {
                                $x = true;
                            }
                        }
                    @endphp
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'মেসেজ প্রদান') {
                                $x = true;
                            }
                        }
                    @endphp
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'আয় ব্যয় হিসাব') {
                                $x = true;
                            }
                        }
                    @endphp
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'রিপোর্ট') {
                                $x = true;
                            }
                        }
                    @endphp
                    ...
                    @php
                        ...
                        for ($i = 0; $i < count($permission_list); $i++) {
                            if ($permission_list[$i]->permission_name == 'সেটিংস') {
                                $x = true;
                            }
                        }
                    @endphp
                ...
                @else
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            href="order.html" aria-expanded="false"><i class="fas fa-file"></i><span
                                class="hide-menu">লগইন/রেজিস্টার
                            </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{ route('auth.employee.login.view') }}"
                                    class="sidebar-link"><i class="fas fa-angle-right"></i><span
                                        class="hide-menu">লগইন
                                    </span></a></li>
