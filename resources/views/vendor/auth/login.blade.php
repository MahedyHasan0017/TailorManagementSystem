    ...
    <div class="auth-box bg-dark border-top border-secondary">
        <div id="loginform">
            <div class="text-center pt-3 pb-3">
                <span class="db"><img src="{{ asset('tailerStaticTemplate/assets/images/logo-text.jpg') }}" alt="logo" /></span>
            </div>
            <!-- Form -->
            <form class="form-horizontal mt-3" action="{{ route('auth.vendor.login.store') }}" method="POST">
                @csrf
                <div class="row pb-4">
                    <div class="col-12">
                        <div>
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" required>
                        ...
                        <div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Password" id="password" name="password" aria-label="Password" aria-describedby="basic-addon1" required>
                ...
                <div class="row border-top border-secondary">
                    ...
                    <div class="col-12">
                        <div class="">
                            <a href="{{ route('auth.vendor.register.view') }}" class="btn btn-info">Have No
