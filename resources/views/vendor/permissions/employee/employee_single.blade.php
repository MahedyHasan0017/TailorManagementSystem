        ...
        <div class="accordion" id="accordionExample">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div>
                        employee mobile number : {{ $employee->mobile_number }}
                    </div>
                    <div>
                        vendor mobile number : {{ $employee->vendor_mobile }}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mt-3">
                    ...
                    <form method="post" action="{{ route('vendor.employee.submit.permissions') }}" enctype="multipart/form-data">
                        @csrf
